...
import 'package:blocprovider/extensions/filter.dart';
...
class NotesService {
  ...
  Future<void> open() async {
    if (_db != null) {
      throw DatabaseAlreadyOpenException(); // throws if db is open n u still trying to open
